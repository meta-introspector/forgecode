...
|---------|--------------|------|
| — | No matches in shmem for 13 keywords | — |
| — | Searchable terms: DiagnosticError, DiagnosticHint, DiagnosticInfo, DiagnosticWarn, Finding, Important, Neovim, Private, RPC, Sending | — |